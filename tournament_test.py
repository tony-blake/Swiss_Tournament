...
def testRegister():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("Chandra Nalaar",num)
    c = countPlayers(num)
    if c != 1:
        raise ValueError(
...
def testRegisterCountDelete():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("Markov Chaney",num)
    registerPlayer("Joe Malik",num)
    registerPlayer("Mao Tsu-hsi",num)
    registerPlayer("Atlanta Hope",num)
    c = countPlayers(num)
    if c != 4:
        raise ValueError(
...
def testStandingsBeforeMatches():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("Melpomene Murray",num)
    registerPlayer("Randy Schwartz",num)
    standings = playerStandings(num)
    if len(standings) < 2:
...
def testReportMatches():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("Bruno Walton",num)
    registerPlayer("Boots O'Neal",num)
    registerPlayer("Cathy Burton",num)
    registerPlayer("Diane Grant",num)
    standings = playerStandings(num)
    [id1, id2, id3, id4] = [row[0] for row in standings]
    reportMatch(num, id1, id2)
    reportMatch(num, id3, id4, 'TRUE')
    standings = playerStandings(num)
...
def testCheckByes():
    ...
    reportBye(id, num)
    standings = playerStandings(num)
    test = checkByes(num, standings, -1)
    if test == -1:
...
def testPairings():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("Twilight Sparkle",num)
    registerPlayer("Fluttershy",num)
    registerPlayer("Applejack",num)
    registerPlayer("Pinkie Pie",num)
    standings = playerStandings(num)
    [id1, id2, id3, id4] = [row[0] for row in standings]
    reportMatch(num, id1, id2)
    reportMatch(num, id3, id4)
    pairings = swissPairings(num)
    if len(pairings) != 2:
        raise ValueError(
...
def testOddPairings():
    ...
    correct_pairs = set([frozenset([id1, id3]), frozenset([id2, id4])])
    actual_pairs = set([frozenset([pid1, pid2]), frozenset([pid3, pid4])])
    if correct_pairs != actual_pairs and not hasBye(id5, num):
        raise ValueError(
...
def testRematch():
    ...
    deleteScoreboard()
    num = createTournament('Test')
    registerPlayer("One", num)
    registerPlayer("Two", num)
    registerPlayer("Three", num)
    registerPlayer("Four", num)
    registerPlayer("Five", num)
    registerPlayer("Six", num)
    standings = playerStandings(num)
    [id1, id2, id3, id4, id5, id6] = [row[0] for row in standings]
    reportMatch(num, id1, id2)
    reportMatch(num, id3, id4)
    reportMatch(num, id5, id6)
    reportMatch(num, id1, id3)
    reportMatch(num, id5, id2)
    reportMatch(num, id4, id6)
    pairings = swissPairings(num)
    if len(pairings) != 3:
        raise ValueError(
